// ========================================
// id_js_img_galaxy_irdt_filaire script
// ========================================

// IRDT filaire
function galaxy_irdt_filaire()
{
    ...
    for (i=0; i<variables.length; i++) {
        if (variables[i].includes("variable_input_galaxy_irdt_filaire")) {
            a.push(variables[i]);
        }
        if (variables[i].includes("variable_large_galaxy_irdt_filaire")) {
            b.push(variables[i]);
        }
    }
    ...
    for (i=0; i<b.length && i<a.length; i++) {
        var dispositif = "IRDT filaire - Numéro du dispositif : " + RMPApplication.get(a[i]);
    ...
    RMPApplication.set("images_galaxy_irdt_filaire", c);
