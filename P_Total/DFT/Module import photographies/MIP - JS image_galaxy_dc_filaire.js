// ========================================
// id_js_img_galaxy_dc_filaire script
// ========================================

// DC filaire
function galaxy_dc_filaire()
{
    ...
    for (i=0; i<variables.length; i++) {
        if (variables[i].includes("variable_input_galaxy_dc_filaire")) {
            a.push(variables[i]);
        }
        if (variables[i].includes("variable_large_galaxy_dc_filaire")) {
            b.push(variables[i]);
        }
    }
    ...
    for (i=0; i<b.length && i<a.length; i++) {
        var dispositif = "DC filaire - Numéro du dispositif : " + RMPApplication.get(a[i]);
    ...
    RMPApplication.set("images_galaxy_dc_filaire", c);
