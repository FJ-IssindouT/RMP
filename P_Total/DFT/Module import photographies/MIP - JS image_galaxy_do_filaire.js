// ========================================
// id_js_img_galaxy_do_filaire script
// ========================================

// DO filaire
function galaxy_do_filaire()
{
    ...
    for (i=0; i<variables.length; i++) {
        if (variables[i].includes("variable_input_galaxy_do_filaire")) {
            a.push(variables[i]);
        }
        if (variables[i].includes("variable_large_galaxy_do_filaire")) {
            b.push(variables[i]);
        }
    }
    ...
    for (i=0; i<b.length && i<a.length; i++) {
        var dispositif = "DO filaire - Numéro du dispositif : " + RMPApplication.get(a[i]);
    ...
    RMPApplication.set("images_galaxy_do_filaire", c);
