...
<!-- Root document -->
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" 
			xmlns:w="http://schemas.microsoft.com/office/word/2003/wordml" font-family="Arial">
			...
			<fo:page-sequence xmlns:rx="http://www.renderx.com/XSL/Extensions" 
				...
				xmlns:aml="http://schemas.microsoft.com/aml/2001/core" 
				xmlns:w10="urn:schemas-microsoft-com:office:word" 
				xmlns:dt="uuid:C2F41010-65B3-11d1-A29F-00AA00C14882" master-reference="section1-page-sequence-master" format="1">
				...
				<fo:flow flow-name="xsl-region-body">
					<fo:block widows="2" orphans="2" font-size="10pt" line-height="1.147" white-space-collapse="false">
									...
									<fo:table-cell padding-top="10pt" padding-left="5.4pt" padding-bottom="10pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="white" border-right-color="white" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="white" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="white">
										<fo:block text-align="center" space-after="0pt" space-after.conditionality="retain" line-height="2" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
											<fo:inline font-weight="bold" color="black" font-size="11pt">
												<fo:leader leader-length="0pt"/>CAMPAGNE TLS 
											</fo:inline>
										</fo:block>
										<fo:block text-align="center" space-after="0pt" space-after.conditionality="retain" line-height="2" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
											<fo:inline font-weight="bold" color="black" font-size="11pt">
												<fo:leader leader-length="0pt"/>DOSSIER DE FIN DE TRAVAUX 
											</fo:inline>
										</fo:block>
										<fo:block text-align="center" space-after="0pt" space-after.conditionality="retain" line-height="2" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
											<fo:inline font-weight="bold" color="black" font-size="11pt">
												<fo:leader leader-length="0pt"/>LOT TÉLÉSURVEILLANCE
											</fo:inline>
										</fo:block>
									</fo:table-cell>
						...
						<fo:table margin-top="1cm" background-color="#FFFFFF" 
							xmlns:st1="urn:schemas-microsoft-com:office:smarttags" font-family="Arial" language="FR" start-indent="0pt" border-top-style="solid" border-top-color="black" border-top-width="0.5pt" border-left-style="solid" border-left-color="black" border-left-width="0.5pt" border-bottom-style="solid" border-bottom-color="black" border-bottom-width="0.5pt" border-right-style="solid" border-right-color="black" border-right-width="0.5pt">
						...
						<fo:table margin-top="" background-color="#FFFFFF" 
								...
								<fo:table-row>
									<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="white" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="WHITE">
										<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR">
											<fo:inline color="BLACK">
												...
												<fo:inline font-weight="bold">Personne en charge : </fo:inline>
									...
									<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="white" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="WHITE">
										<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR">
											<fo:inline color="BLACK">
												<fo:leader leader-length="0pt"/>
												<fo:inline font-weight="bold">Date de réalisation : </fo:inline>
												<xsl:value-of select="date_realisation"/>
											</fo:inline>
										</fo:block>
									</fo:table-cell>
								</fo:table-row>
						...
						<fo:table margin-bottom="0.7cm" padding-bottom="0pt" background-color="#FFFFFF" 
								...
								<fo:table-row>
									<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="white" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="white" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="white">
										<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR">
											<fo:inline color="black">
												<fo:leader leader-length="0pt"/>
												<fo:inline font-weight="bold">Nature des travaux : </fo:inline>
												<xsl:value-of select="nature_traveaux"/>
											</fo:inline>
										</fo:block>
									</fo:table-cell>
								</fo:table-row>
						...
						<fo:table background-color="#FFFFFF" 
							xmlns:st1="urn:schemas-microsoft-com:office:smarttags" font-family="Arial" language="FR" start-indent="0pt" border-top-style="solid" border-top-color="black" border-top-width="0.5pt" border-left-style="solid" border-left-color="black" border-left-width="0.5pt" border-bottom-style="solid" border-bottom-color="white" border-bottom-width="0.5pt" border-right-style="solid" border-right-color="black" border-right-width="0.5pt">
								...
								<fo:table-row>
									<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="white" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="white" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="white">
										<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR">
											<fo:inline color="black">
												<fo:leader leader-length="0pt"/>
												<fo:inline font-weight="bold">Code d'implant : </fo:inline>
									...
									<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="white" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="white" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="white">
										<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR">
											<fo:inline color="black">
												<fo:leader leader-length="0pt"/>
												<fo:inline font-weight="bold">Nom de la station : </fo:inline>
								...
								<fo:table-row>
									...
									<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="white" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="white" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="white">
										<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR">
											<fo:inline color="black">
												<fo:leader leader-length="0pt"/>
												<fo:inline font-weight="bold">Téléphone : </fo:inline>
												<xsl:value-of select="telservice"/>
											</fo:inline>
										</fo:block>
									</fo:table-cell>
								</fo:table-row>
						...
						<xsl:variable name="users_array">
							<xsl:value-of select="users_array"/>
						</xsl:variable>
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>Centrale d'alarme
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
						...
						<xsl:variable name="images_clavier_principal">
							<xsl:value-of select="images_clavier_principal"/>
						</xsl:variable>
						<xsl:if test="$images_clavier_principal != ''">
							<fo:table margin-bottom="0.7cm" background-color="#FFFFFF" 
								xmlns:st1="urn:schemas-microsoft-com:office:smarttags" font-family="Arial" language="FR" start-indent="0pt" border-top-style="solid" border-top-color="black" border-top-width="0.5pt" border-left-style="solid" border-left-color="black" border-left-width="0.5pt" border-bottom-style="solid" border-bottom-color="black" border-bottom-width="0.5pt" border-right-style="solid" border-right-color="black" border-right-width="0.5pt">
								<fo:table-column column-width="556px"/>
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>Clavier principal de la centrale d'alarme
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
						...
						<xsl:variable name="images_antenne">
							<xsl:value-of select="images_antenne"/>
						</xsl:variable>
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>Antenne externe
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
						...
						<xsl:variable name="images_detecteur_irp">
							<xsl:value-of select="images_detecteur_irp"/>
						</xsl:variable>
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>Détecteur IRP Double Technologie
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
						...
						<xsl:variable name="images_detecteur_irp_simple">
							<xsl:value-of select="images_detecteur_irp_simple"/>
						</xsl:variable>
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>Détecteur IRP Simple Technologie
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
						...
						<xsl:variable name="images_detecteur_mouvement">
							<xsl:value-of select="images_detecteur_mouvement"/>
						</xsl:variable>
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>Détecteur de mouvement avec vidéo IRVPI
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
						...
						<xsl:variable name="images_detecteur_ouverture">
							<xsl:value-of select="images_detecteur_ouverture"/>
						</xsl:variable>
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>Détecteur d'ouverture
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
						...
						<xsl:variable name="images_detecteur_lasco">
							<xsl:value-of select="images_detecteur_lasco"/>
						</xsl:variable>
						<xsl:if test="$images_detecteur_lasco != ''">
							<fo:table margin-bottom="0.7cm" background-color="#FFFFFF" 
								xmlns:st1="urn:schemas-microsoft-com:office:smarttags" font-family="Arial" language="FR" start-indent="0pt" border-top-style="solid" border-top-color="black" border-top-width="0.5pt" border-left-style="solid" border-left-color="black" border-left-width="0.5pt" border-bottom-style="solid" border-bottom-color="black" border-bottom-width="0.5pt" border-right-style="solid" border-right-color="black" border-right-width="0.5pt">
								<fo:table-column column-width="556px"/>
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>Détecteur Lasco
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
									<xsl:apply-templates select="images_detecteur_lasco"/>
								</fo:table-body>
							</fo:table>
						</xsl:if>

						<xsl:variable name="images_bouton_huf">
							<xsl:value-of select="images_bouton_huf"/>
						</xsl:variable>
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>Bouton agression HUF
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
						...
						<xsl:variable name="images_medaillon_alerte">
							<xsl:value-of select="images_medaillon_alerte"/>
						</xsl:variable>
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>Médaillon d'alerte mobile
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
						...
						<xsl:variable name="images_pedale">
							<xsl:value-of select="images_pedale"/>
						</xsl:variable>
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>Pédale de caisse
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
						...
						<xsl:variable name="images_sirene_interieure">
							<xsl:value-of select="images_sirene_interieure"/>
						</xsl:variable>
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>Sirène intérieure
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
						...
						<xsl:variable name="images_sirene_exterieure">
							<xsl:value-of select="images_sirene_exterieure"/>
						</xsl:variable>
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>Sirène extérieure
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
						...
						<xsl:variable name="images_sabot">
							<xsl:value-of select="images_sabot"/>
						</xsl:variable>
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>Sabot
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
						...
						<xsl:variable name="images_detecteur_choc">
							<xsl:value-of select="images_detecteur_choc"/>
						</xsl:variable>
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>Détecteur de choc
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
						...
						<xsl:variable name="images_reports_alarme">
							<xsl:value-of select="images_reports_alarme"/>
						</xsl:variable>
						<xsl:if test="$images_reports_alarme != ''">
							<fo:table margin-bottom="0.7cm" background-color="#FFFFFF" 
								xmlns:st1="urn:schemas-microsoft-com:office:smarttags" font-family="Arial" language="FR" start-indent="0pt" border-top-style="solid" border-top-color="black" border-top-width="0.5pt" border-left-style="solid" border-left-color="black" border-left-width="0.5pt" border-bottom-style="solid" border-bottom-color="black" border-bottom-width="0.5pt" border-right-style="solid" border-right-color="black" border-right-width="0.5pt">
								<fo:table-column column-width="556px"/>
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>Reports Alarme
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
									<xsl:apply-templates select="images_reports_alarme"/>
								</fo:table-body>
							</fo:table>
						</xsl:if>
						...
						<xsl:variable name="images_galaxy_centrale_alarme">
							<xsl:value-of select="images_galaxy_centrale_alarme"/>
						</xsl:variable>
						<xsl:if test="$images_galaxy_centrale_alarme != ''">
							<fo:table margin-bottom="0.7cm" background-color="#FFFFFF" 
								xmlns:st1="urn:schemas-microsoft-com:office:smarttags" font-family="Arial" language="FR" start-indent="0pt" border-top-style="solid" border-top-color="black" border-top-width="0.5pt" border-left-style="solid" border-left-color="black" border-left-width="0.5pt" border-bottom-style="solid" border-bottom-color="black" border-bottom-width="0.5pt" border-right-style="solid" border-right-color="black" border-right-width="0.5pt">
								<fo:table-column column-width="556px"/>
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>Centrale Alarme Galaxy Flex
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
									<xsl:apply-templates select="images_galaxy_centrale_alarme"/>
								</fo:table-body>
							</fo:table>
						</xsl:if>


						<xsl:variable name="images_galaxy_clavier">
							<xsl:value-of select="images_galaxy_clavier"/>
						</xsl:variable>
						<xsl:if test="$images_galaxy_clavier != ''">
							<fo:table margin-bottom="0.7cm" background-color="#FFFFFF" 
								xmlns:st1="urn:schemas-microsoft-com:office:smarttags" font-family="Arial" language="FR" start-indent="0pt" border-top-style="solid" border-top-color="black" border-top-width="0.5pt" border-left-style="solid" border-left-color="black" border-left-width="0.5pt" border-bottom-style="solid" border-bottom-color="black" border-bottom-width="0.5pt" border-right-style="solid" border-right-color="black" border-right-width="0.5pt">
								<fo:table-column column-width="556px"/>
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>Clavier
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
									<xsl:apply-templates select="images_galaxy_clavier"/>
								</fo:table-body>
							</fo:table>
						</xsl:if>


						<xsl:variable name="images_galaxy_sirene_interieure">
							<xsl:value-of select="images_galaxy_sirene_interieure"/>
						</xsl:variable>
						<xsl:if test="$images_galaxy_sirene_interieure != ''">
							<fo:table margin-bottom="0.7cm" background-color="#FFFFFF" 
								xmlns:st1="urn:schemas-microsoft-com:office:smarttags" font-family="Arial" language="FR" start-indent="0pt" border-top-style="solid" border-top-color="black" border-top-width="0.5pt" border-left-style="solid" border-left-color="black" border-left-width="0.5pt" border-bottom-style="solid" border-bottom-color="black" border-bottom-width="0.5pt" border-right-style="solid" border-right-color="black" border-right-width="0.5pt">
								<fo:table-column column-width="556px"/>
								<fo:table-body start-indent="0pt">
									...
									<xsl:apply-templates select="images_galaxy_sirene_interieure"/>
								</fo:table-body>
							</fo:table>
						</xsl:if>


						<xsl:variable name="images_galaxy_sirene_exterieure">
							<xsl:value-of select="images_galaxy_sirene_exterieure"/>
						</xsl:variable>
						<xsl:if test="$images_galaxy_sirene_exterieure != ''">
							<fo:table margin-bottom="0.7cm" background-color="#FFFFFF" 
								xmlns:st1="urn:schemas-microsoft-com:office:smarttags" font-family="Arial" language="FR" start-indent="0pt" border-top-style="solid" border-top-color="black" border-top-width="0.5pt" border-left-style="solid" border-left-color="black" border-left-width="0.5pt" border-bottom-style="solid" border-bottom-color="black" border-bottom-width="0.5pt" border-right-style="solid" border-right-color="black" border-right-width="0.5pt">
								<fo:table-column column-width="556px"/>
								<fo:table-body start-indent="0pt">
									...
									<xsl:apply-templates select="images_galaxy_sirene_exterieure"/>
								</fo:table-body>
							</fo:table>
						</xsl:if>


						<xsl:variable name="images_galaxy_rio">
							<xsl:value-of select="images_galaxy_rio"/>
						</xsl:variable>
						<xsl:if test="$images_galaxy_rio != ''">
							<fo:table margin-bottom="0.7cm" background-color="#FFFFFF" 
								xmlns:st1="urn:schemas-microsoft-com:office:smarttags" font-family="Arial" language="FR" start-indent="0pt" border-top-style="solid" border-top-color="black" border-top-width="0.5pt" border-left-style="solid" border-left-color="black" border-left-width="0.5pt" border-bottom-style="solid" border-bottom-color="black" border-bottom-width="0.5pt" border-right-style="solid" border-right-color="black" border-right-width="0.5pt">
								<fo:table-column column-width="556px"/>
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>RIO
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
									<xsl:apply-templates select="images_galaxy_rio"/>
								</fo:table-body>
							</fo:table>
						</xsl:if>


						<xsl:variable name="images_galaxy_rf">
							<xsl:value-of select="images_galaxy_rf"/>
						</xsl:variable>
						<xsl:if test="$images_galaxy_rf != ''">
							<fo:table margin-bottom="0.7cm" background-color="#FFFFFF" 
								xmlns:st1="urn:schemas-microsoft-com:office:smarttags" font-family="Arial" language="FR" start-indent="0pt" border-top-style="solid" border-top-color="black" border-top-width="0.5pt" border-left-style="solid" border-left-color="black" border-left-width="0.5pt" border-bottom-style="solid" border-bottom-color="black" border-bottom-width="0.5pt" border-right-style="solid" border-right-color="black" border-right-width="0.5pt">
								<fo:table-column column-width="556px"/>
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>RF
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
									<xsl:apply-templates select="images_galaxy_rf"/>
								</fo:table-body>
							</fo:table>
						</xsl:if>


						<xsl:variable name="images_galaxy_irv_filaire">
							<xsl:value-of select="images_galaxy_irv_filaire"/>
						</xsl:variable>
						<xsl:if test="$images_galaxy_irv_filaire != ''">
							<fo:table margin-bottom="0.7cm" background-color="#FFFFFF" 
								xmlns:st1="urn:schemas-microsoft-com:office:smarttags" font-family="Arial" language="FR" start-indent="0pt" border-top-style="solid" border-top-color="black" border-top-width="0.5pt" border-left-style="solid" border-left-color="black" border-left-width="0.5pt" border-bottom-style="solid" border-bottom-color="black" border-bottom-width="0.5pt" border-right-style="solid" border-right-color="black" border-right-width="0.5pt">
								<fo:table-column column-width="556px"/>
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>IRV filaire
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
									<xsl:apply-templates select="images_galaxy_irv_filaire"/>
								</fo:table-body>
							</fo:table>
						</xsl:if>


						<xsl:variable name="images_galaxy_irdt_filaire">
							<xsl:value-of select="images_galaxy_irdt_filaire"/>
						</xsl:variable>
						<xsl:if test="$images_galaxy_irdt_filaire != ''">
							<fo:table margin-bottom="0.7cm" background-color="#FFFFFF" 
								xmlns:st1="urn:schemas-microsoft-com:office:smarttags" font-family="Arial" language="FR" start-indent="0pt" border-top-style="solid" border-top-color="black" border-top-width="0.5pt" border-left-style="solid" border-left-color="black" border-left-width="0.5pt" border-bottom-style="solid" border-bottom-color="black" border-bottom-width="0.5pt" border-right-style="solid" border-right-color="black" border-right-width="0.5pt">
								<fo:table-column column-width="556px"/>
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>IRDT filaire
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
									<xsl:apply-templates select="images_galaxy_irdt_filaire"/>
								</fo:table-body>
							</fo:table>
						</xsl:if>


						<xsl:variable name="images_galaxy_dc_filaire">
							<xsl:value-of select="images_galaxy_dc_filaire"/>
						</xsl:variable>
						<xsl:if test="$images_galaxy_dc_filaire != ''">
							<fo:table margin-bottom="0.7cm" background-color="#FFFFFF" 
								xmlns:st1="urn:schemas-microsoft-com:office:smarttags" font-family="Arial" language="FR" start-indent="0pt" border-top-style="solid" border-top-color="black" border-top-width="0.5pt" border-left-style="solid" border-left-color="black" border-left-width="0.5pt" border-bottom-style="solid" border-bottom-color="black" border-bottom-width="0.5pt" border-right-style="solid" border-right-color="black" border-right-width="0.5pt">
								<fo:table-column column-width="556px"/>
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>DC filaire
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
									<xsl:apply-templates select="images_galaxy_dc_filaire"/>
								</fo:table-body>
							</fo:table>
						</xsl:if>


						<xsl:variable name="images_galaxy_do_filaire">
							<xsl:value-of select="images_galaxy_do_filaire"/>
						</xsl:variable>
						<xsl:if test="$images_galaxy_do_filaire != ''">
							<fo:table margin-bottom="0.7cm" background-color="#FFFFFF" 
								xmlns:st1="urn:schemas-microsoft-com:office:smarttags" font-family="Arial" language="FR" start-indent="0pt" border-top-style="solid" border-top-color="black" border-top-width="0.5pt" border-left-style="solid" border-left-color="black" border-left-width="0.5pt" border-bottom-style="solid" border-bottom-color="black" border-bottom-width="0.5pt" border-right-style="solid" border-right-color="black" border-right-width="0.5pt">
								<fo:table-column column-width="556px"/>
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>DO filaire
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
									<xsl:apply-templates select="images_galaxy_do_filaire"/>
								</fo:table-body>
							</fo:table>
						</xsl:if>


						<xsl:variable name="images_camera_interieure">
							<xsl:value-of select="images_camera_interieure"/>
						</xsl:variable>
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>Caméra intérieure
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
						...
						<xsl:variable name="images_camera_exterieure">
							<xsl:value-of select="images_camera_exterieure"/>
						</xsl:variable>
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>Caméra extérieure
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
						...
						<xsl:variable name="images_moniteur_bureau">
							<xsl:value-of select="images_moniteur_bureau"/>
						</xsl:variable>
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>Moniteur vidéo de bureau
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
						...
						<xsl:variable name="images_moniteur_caisse">
							<xsl:value-of select="images_moniteur_caisse"/>
						</xsl:variable>
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>Moniteur vidéo de caisse
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
						...
						<xsl:variable name="images_uc_tls">
							<xsl:value-of select="images_uc_tls"/>
						</xsl:variable>
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>UC TLS dans la baie
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
						...
						<xsl:variable name="images_nas">
							<xsl:value-of select="images_nas"/>
						</xsl:variable>
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>NAS dans la baie
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
						...
						<xsl:variable name="images_switch_tls">
							<xsl:value-of select="images_switch_tls"/>
						</xsl:variable>
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>Switch TLS dans la baie
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
						...
						<xsl:variable name="images_boitier_plexo">
							<xsl:value-of select="images_boitier_plexo"/>
						</xsl:variable>
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>Boîtier Plexo ADAM
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
						...
						<xsl:variable name="images_injecteur_rackable">
							<xsl:value-of select="images_injecteur_rackable"/>
						</xsl:variable>
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>Injecteurs rackabke
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
						...
						<xsl:variable name="images_injecteur_unitaires">
							<xsl:value-of select="images_injecteur_unitaires"/>
						</xsl:variable>
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>Injecteurs unitaires
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
						...
						<xsl:variable name="images_adhesifs">
							<xsl:value-of select="images_adhesifs"/>
						</xsl:variable>
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>Adhesifs réglementaires
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
						...
						<xsl:variable name="images_detecteur_fumee">
							<xsl:value-of select="images_detecteur_fumee"/>
						</xsl:variable>
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>Détecteur de fumée
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
						...
						<xsl:variable name="images_controleur">
							<xsl:value-of select="images_controleur"/>
						</xsl:variable>
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>Contrôleur d'accès
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
						...
						<xsl:variable name="images_digicode">
							<xsl:value-of select="images_digicode"/>
						</xsl:variable>
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>Digicode
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
						...
						<xsl:variable name="images_interphone">
							<xsl:value-of select="images_interphone"/>
						</xsl:variable>
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>Interphone
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
						...
						<xsl:variable name="images_hp">
							<xsl:value-of select="images_hp"/>
						</xsl:variable>
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>HP
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
						...
						<xsl:variable name="images_amplificateur">
							<xsl:value-of select="images_amplificateur"/>
						</xsl:variable>
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>Amplificateur
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
						...
						<xsl:variable name="images_centrale_interphonie">
							<xsl:value-of select="images_centrale_interphonie"/>
						</xsl:variable>
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#034EA2">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>Centrale d'interphonie
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
						...
						<xsl:variable name="numeros_serie">
							<xsl:value-of select="numeros_serie"/>
						</xsl:variable>
								...
								<fo:table-body start-indent="0pt">
									<fo:table-row keep-with-next="always">
										<fo:table-cell padding-top="0pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#4596D1">
											<fo:block space-after="0pt" space-after.conditionality="retain" line-height="3" font-family="Arial" font-size="9pt" language="FR" font-weight="bold">
												<fo:inline font-weight="bold" color="white">
													<fo:leader leader-length="0pt"/>Numéro de série des équipements
												</fo:inline>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
...
<!-- Template: affiche les données utilisateur -->
			...
			<fo:table-body start-indent="0pt">
				...
				<fo:table-row keep-with-next="always">
					<fo:table-cell text-align="center" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="white" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="white">
						<fo:block space-after="0pt" space-after.conditionality="retain" line-height="1.147" font-family="Arial" font-size="11pt" language="FR">
							<fo:inline color="black">
								<fo:leader leader-length="0pt"/>Plan large
							</fo:inline>
						</fo:block>
					</fo:table-cell>
				</fo:table-row>
	...
	<xsl:template match="images_detecteur_mouvement">
		...
		<fo:table-row keep-with-next="always">
			<fo:table-cell text-align="center" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="white" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="white">
				<fo:block space-after="0pt" space-after.conditionality="retain" line-height="1.147" font-family="Arial" font-size="11pt" language="FR">
					<fo:inline color="black">
						<fo:leader leader-length="0pt"/>Vue de l'IRV
					</fo:inline>
				</fo:block>
			</fo:table-cell>
		</fo:table-row>
			...
			<fo:table-cell text-align="center" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="white" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="white">
				<fo:block space-after="0pt" space-after.conditionality="retain" line-height="1.147" font-family="Arial" font-size="11pt" language="FR">
					<fo:inline>
						<fo:leader leader-length="0pt"/>
						<xsl:variable name="image">
							<xsl:value-of select="url_vu_irv"/>
						</xsl:variable>
						<fo:external-graphic content-height="300pt" content-width="700pt">
							<xsl:attribute name="src">
								<xsl:value-of select="$image" />
...
<!-- Template: XXXXX -->
	<xsl:template match="images_detecteur_lasco">
		<fo:table-row keep-with-next="always">
			<fo:table-cell padding-top="5pt" padding-left="5.4pt" padding-bottom="5pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="white">
				<fo:block space-after="0pt" space-after.conditionality="retain" line-height="1.147" font-family="Arial" font-size="11pt" language="FR">
					<fo:inline>
...
<!-- Template: XXXXX -->
	<xsl:template match="images_galaxy_centrale_alarme">
		<fo:table-row keep-with-next="always">
			<fo:table-cell padding-top="5pt" padding-left="5.4pt" padding-bottom="5pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="white">
				<fo:block space-after="0pt" space-after.conditionality="retain" line-height="1.147" font-family="Arial" font-size="11pt" language="FR">
					<fo:inline>
...
<!-- Template: XXXXX -->
	<xsl:template match="images_galaxy_clavier">
		<fo:table-row keep-with-next="always">
			<fo:table-cell padding-top="5pt" padding-left="5.4pt" padding-bottom="5pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="white">
				<fo:block space-after="0pt" space-after.conditionality="retain" line-height="1.147" font-family="Arial" font-size="11pt" language="FR">
					<fo:inline>
...
<!-- Template: XXXXX -->
	<xsl:template match="images_galaxy_sirene_interieure">
		<fo:table-row keep-with-next="always">
			<fo:table-cell padding-top="5pt" padding-left="5.4pt" padding-bottom="5pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="white">
				<fo:block space-after="0pt" space-after.conditionality="retain" line-height="1.147" font-family="Arial" font-size="11pt" language="FR">
					<fo:inline>
...
<!-- Template: XXXXX -->
	<xsl:template match="images_galaxy_sirene_exterieure">
		<fo:table-row keep-with-next="always">
			<fo:table-cell padding-top="5pt" padding-left="5.4pt" padding-bottom="5pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="white">
				<fo:block space-after="0pt" space-after.conditionality="retain" line-height="1.147" font-family="Arial" font-size="11pt" language="FR">
					<fo:inline>
...
<!-- Template: XXXXX -->
	<xsl:template match="images_galaxy_rio">
		<fo:table-row keep-with-next="always">
			<fo:table-cell padding-top="5pt" padding-left="5.4pt" padding-bottom="5pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="white">
				<fo:block space-after="0pt" space-after.conditionality="retain" line-height="1.147" font-family="Arial" font-size="11pt" language="FR">
					<fo:inline>
...
<!-- Template: XXXXX -->
	<xsl:template match="images_galaxy_rf">
		<fo:table-row keep-with-next="always">
			<fo:table-cell padding-top="5pt" padding-left="5.4pt" padding-bottom="5pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="white">
				<fo:block space-after="0pt" space-after.conditionality="retain" line-height="1.147" font-family="Arial" font-size="11pt" language="FR">
					<fo:inline>
...
<!-- Template: XXXXX -->
	<xsl:template match="images_galaxy_irv_filaire">
		<fo:table-row keep-with-next="always">
			<fo:table-cell padding-top="5pt" padding-left="5.4pt" padding-bottom="5pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="white">
				<fo:block space-after="0pt" space-after.conditionality="retain" line-height="1.147" font-family="Arial" font-size="11pt" language="FR">
					<fo:inline>
			...
			<fo:table-cell text-align="center" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="white" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="white">
				<fo:block space-after="0pt" space-after.conditionality="retain" line-height="1.147" font-family="Arial" font-size="11pt" language="FR">
					<fo:inline>
						<fo:leader leader-length="0pt"/>
						<xsl:variable name="image">
							<xsl:value-of select="url_vu_galaxy_irv_filaire"/>
						</xsl:variable>
						<fo:external-graphic content-height="300pt" content-width="700pt">
							<xsl:attribute name="src">
								<xsl:value-of select="$image" />
...
<!-- Template: XXXXX -->
	<xsl:template match="images_galaxy_irdt_filaire">
		<fo:table-row keep-with-next="always">
			<fo:table-cell padding-top="5pt" padding-left="5.4pt" padding-bottom="5pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="white">
				<fo:block space-after="0pt" space-after.conditionality="retain" line-height="1.147" font-family="Arial" font-size="11pt" language="FR">
					<fo:inline>
...
<!-- Template: XXXXX -->
	<xsl:template match="images_galaxy_dc_filaire">
		<fo:table-row keep-with-next="always">
			<fo:table-cell padding-top="5pt" padding-left="5.4pt" padding-bottom="5pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="white">
				<fo:block space-after="0pt" space-after.conditionality="retain" line-height="1.147" font-family="Arial" font-size="11pt" language="FR">
					<fo:inline>
...
<!-- Template: XXXXX -->
	<xsl:template match="images_galaxy_do_filaire">
		<fo:table-row keep-with-next="always">
			<fo:table-cell padding-top="5pt" padding-left="5.4pt" padding-bottom="5pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="white">
				<fo:block space-after="0pt" space-after.conditionality="retain" line-height="1.147" font-family="Arial" font-size="11pt" language="FR">
					<fo:inline>
	...
	<xsl:template match="images_camera_interieure">
		...
		<fo:table-row keep-with-next="always">
			<fo:table-cell text-align="center" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="white" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="white">
				<fo:block space-after="0pt" space-after.conditionality="retain" line-height="1.147" font-family="Arial" font-size="11pt" language="FR">
					<fo:inline color="black">
						<fo:leader leader-length="0pt"/>Vue de jour
					</fo:inline>
				</fo:block>
			</fo:table-cell>
		</fo:table-row>
		...
		<fo:table-row keep-with-next="always">
			<fo:table-cell text-align="center" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="white" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="white">
				<fo:block space-after="0pt" space-after.conditionality="retain" line-height="1.147" font-family="Arial" font-size="11pt" language="FR">
					<fo:inline color="black">
						<fo:leader leader-length="0pt"/>Vue de nuit
					</fo:inline>
				</fo:block>
			</fo:table-cell>
		</fo:table-row>
	...
	<xsl:template match="images_moniteur_bureau">
		...
		<fo:table-row keep-with-next="always">
			<fo:table-cell text-align="center" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="white" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="white">
				<fo:block space-after="0pt" space-after.conditionality="retain" line-height="1.147" font-family="Arial" font-size="11pt" language="FR">
					<fo:inline color="black">
						<fo:leader leader-length="0pt"/>Vue
					</fo:inline>
				</fo:block>
			</fo:table-cell>
		</fo:table-row>
...
<!-- Template: XXXXX -->
	<xsl:template match="images_reports_alarme">
		<fo:table-row keep-with-next="always">
			<fo:table-cell padding-top="5pt" padding-left="5.4pt" padding-bottom="5pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="white" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="white">
				<fo:block space-after="0pt" space-after.conditionality="retain" line-height="1.147" font-family="Arial" font-size="11pt" language="FR">
					<fo:inline>
